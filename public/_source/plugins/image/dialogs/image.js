									...
									[
										...
										},
										{
											...
											{												
												...
												var dialog = this.getDialog();
												var original = dialog.originalElement;
												original.setAttribute( 'placeholder', '1~770' );												
											}
										},
										{
											/////高度/////
										...
										},	
										{
											...
											html : '<div>'+
												...
												'" class="cke_btn_locked" style="display:none;" id="' + btnLockSizesId + '" role="checkbox"><span class="cke_icon"></span><span class="cke_label">' + editor.lang.image.lockRatio + '</span></a>' +
												'<a href="javascript:void(0)" tabindex="-1" title="' + editor.lang.image.resetSize +
												'" class="cke_btn_reset" style="display:none;" id="' + btnResetSizeId + '" role="button"><span class="cke_label">' + editor.lang.image.resetSize + '</span></a>'+
												'</div>'
										}
										/*,
										{
