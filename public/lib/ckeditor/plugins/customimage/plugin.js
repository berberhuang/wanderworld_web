...
(function() {
	...
	CKEDITOR.plugins.add( 'customimage', {
		...
		icons: 'customimage', // %REMOVE_LINE_CORE%
		init: function( editor ) {
			var pluginName = 'customimage';
			var editName = 'editimage';
			
			// Register the dialog.
			CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/custom_image.js' );
			CKEDITOR.dialog.add( editName, this.path + 'dialogs/edit_image.js' );



			// Register the command.
			editor.addCommand( pluginName, new CKEDITOR.dialogCommand( pluginName ) );
			editor.addCommand( editName, new CKEDITOR.dialogCommand( editName ) );

			// Register the toolbar button.
			editor.ui.addButton && editor.ui.addButton( 'CustomImage', {
